...
program $19pointers
    ...
    integer, pointer, dimension(:) :: a_ptr1    ! Pointer to an array
    ! Declare a target whose value changes as the pointers value changes
    ...
    ptr2 => target1
    ptr2 = 1
    print"(/,a5,i1,a9,i1)", "ptr2: ", ptr2, "    tar1: ", target1
    
    ! Now change pointer ptr2
    ptr2 = ptr2 + 2
    print"(/,a5,i1,a9,i1)", "ptr2: ", ptr2, "    tar1: ", target1
